...
namespace Projet_IMA
{
    static class ProjetEleve
    {
        public static void Go()
        {
            ...
            LampeDirectionnelle lampeDirectionnelle = new LampeDirectionnelle(new V3(1, -1, 1), new Couleur(1, 1, 1));
            ...
            Sphere sphere = new Sphere(new V3(300, 200, 400), 100, materialSphere1);
            sphere.DrawSphere(lampeDirectionnelle, CameraPosition);

            Sphere sphere2 = new Sphere(new V3(500, 200, 400), 100, materialSphere2);
            sphere2.DrawSphere(lampeDirectionnelle, CameraPosition);

            Sphere sphere3 = new Sphere(new V3(700, 200, 400), 100, materialSphere3);
            sphere3.DrawSphere(lampeDirectionnelle, CameraPosition);
            //////////////////////////////////////////////////////////////////////////
            ///
